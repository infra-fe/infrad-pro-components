...
import { Button, Result, Avatar, Space, Tag } from 'infrad';
import { CrownOutlined, LeftOutlined, UserOutlined, SmileOutlined } from 'infra-design-icons';
import ProLayout from 'infrad-pro-layout';
