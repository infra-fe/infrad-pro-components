...
<code hideActions='["CSB"]' src="./demos/base.tsx" iframe="650px" />
...
<code hideActions='["CSB"]' src="./demos/dynamicMenu.tsx" iframe="500px" />
...
<code hideActions='["CSB"]' src="./demos/antd@4MenuIconFormServe.tsx" iframe="500px" />
...
<code hideActions='["CSB"]' src="./demos/customizeMenu.tsx" iframe="500px" />
...
<code hideActions='["CSB"]' src="./demos/footer.tsx" iframe="500px" />

This is used to show various applications of ProLayout, if you think your usage can help others, feel free to PR.

### Search menu

<code hideActions='["CSB"]' src="./demos/searchMenu.tsx" iframe="500px" />

### Multiple routes correspond to one menu item

<code hideActions='["CSB"]' src="./demos/MultipleMenuOnePath.tsx" iframe="500px" />

### Open all menus by default

<code hideActions='["CSB"]' src="./demos/DefaultOpenAllMenu.tsx" iframe="500px" />

### Using IconFont

<code hideActions='["CSB"]' src="./demos/IconFont.tsx" iframe="500px" />

### ghost mode

PageContainer configuration `ghost` can switch the page header to transparent mode.

<code hideActions='["CSB"]' src="./demos/ghost.tsx" iframe="500px" />

### Nested Layout

<code hideActions='["CSB"]' src="./demos/Nested.tsx" iframe="500px" />

### Customized collapsed

<code hideActions='["CSB"]' src="./demos/customize-collapsed.tsx" iframe="500px" />
