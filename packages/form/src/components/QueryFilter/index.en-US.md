...
<code hideActions='["CSB"]' src="./demos/query-filter.tsx" height="168px"/>

### Query filter - put away by default

<code hideActions='["CSB"]' src="./demos/query-filter-collapsed.tsx" height="56px"/>

### query-filter-vertical-layout

<code hideActions='["CSB"]' src="./demos/query-filter-vertical.tsx" height="172px"/>

### query-filter-search

<code hideActions='["CSB"]' src="./demos/search-filter.tsx" background="#f0f2f5" height="274px"/>

### Lightweight filtering

<code hideActions='["CSB"]' src="./demos/light-filter.tsx" height="86px"/>

### Light filtering - border mode

<code hideActions='["CSB"]' src="./demos/light-filter-bordered.tsx" height="32px" />
...
<code hideActions='["CSB"]' src="./demos/light-filter-collapse.tsx" height="40px"/>
