...
<code hideActions='["CSB"]' src="./demos/schema.tsx" height="764px" title="schema 表单" />

### JSON 来生成分步表单

<code hideActions='["CSB"]' src="./demos/steps-form.tsx" height="464px" title="schema 表单" />

### 嵌入到 ProForm 中

<code hideActions='["CSB"]' src="./demos/embed.tsx" height="464px" title="schema 表单" />

### 使用 ProFormDependency

<code hideActions='["CSB"]' src="./demos/dependency.tsx" height="300px" title="schema 表单" />
