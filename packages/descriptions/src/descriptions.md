...
<code hideActions='["CSB"]' src="./demos/base.tsx" title="基础定义列表" />

### 数组类型 dataIndex

<code hideActions='["CSB"]' src="./demos/arrayDataIndex.tsx" title="数组类型dataIndex" />
...
<code hideActions='["CSB"]' src="./demos/request.tsx" title="远程请求数据" />

### columns 配置

通过请求接口数据和 columns 来展示定义列表

<code hideActions='["CSB"]' src="./demos/columns.tsx" title="columns 配置" />

### dataSource 配置数据

ProDescriptions 支持了和 Table 相同的 dataSource

<code hideActions='["CSB"]' src="./demos/use-data-source.tsx" title="dataSource 配置数据"/>

### 可编辑的定义列表

API 与 ProTable 相同

<code hideActions='["CSB"]' src="./demos/editable.tsx" title="可编辑的定义列表" />
