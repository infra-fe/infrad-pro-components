...
<code hideActions='["CSB"]' src="./demos/drag.tsx" background="#f5f5f5" height="360px" title="Drag sort" />

### Drag and drop to sort and edit the table

<code hideActions='["CSB"]' src="./demos/drag-sort-table.tsx" background="#f5f5f5" height="360px" title="Editable table" />
